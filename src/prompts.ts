          ...
          messages: [
            {
              ...
              content: {
                ...
                text: [
                  ...
                  '1. List organization index pages and filter the returned records locally by name to get the organization ID; follow nextPage when present,',
                  '2. List configuration index pages for the organization and follow nextPage when present,',
                  '3. List both standard documents and relevant flexible asset types for the organization; these are separate stores, and each index may require additional pages,',
          ...
          messages: [
            {
              ...
              content: {
                ...
                text: [
                  ...
                  '',
                  'Use the available IT Glue tools to:',
                  '1. List organization index pages and filter the returned records locally by name to get its ID, following nextPage when present,',
                  '2. List configuration index pages for the organization and follow nextPage when present,',
                  `3. ${args?.system_name ? `Focus on configurations matching "${args.system_name}"` : 'For each configuration'},`,
                  '   inspect standard-document and relevant flexible-asset index pages for runbooks',
          ...
          messages: [
            {
              ...
              content: {
                ...
                text: [
                  ...
                  'Use the available IT Glue tools to:',
                  '1. List organization index pages and filter the returned records locally by name to get its ID, following nextPage when present,',
                  '2. List password metadata index pages for the organization and follow nextPage when present,',
                  ...
                  '',
                  'Do not call get_password with show_password=true and do NOT display actual password values in the report.',
                ].join('\n'),
              },
            },
          ],
